...
HX_DEFINE_DYNAMIC_FUNC2(Control_Listener_obj,controlEvent,)
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(Control_Listener_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(Control_Listener_obj::__mClass,"__mClass");
};

#endif

Class Control_Listener_obj::__mClass;

void Control_Listener_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("org.gameplay3d.Control_Listener"), hx::TCanCast< Control_Listener_obj> ,0,sMemberFields,
	0, 0,
...
void Control_Listener_obj::__boot()
{
}
