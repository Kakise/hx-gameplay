...
#define INCLUDED_org_gameplay3d_intern_impl_AnimationTargetImpl
...
class HXCPP_CLASS_ATTRIBUTES  AnimationTargetImpl_obj : public ::org::gameplay3d::GameplayObject_obj{
	public:
		typedef ::org::gameplay3d::GameplayObject_obj super;
		typedef AnimationTargetImpl_obj OBJ_;
		AnimationTargetImpl_obj();
		Void __construct(Dynamic nativeObjectInitializer,Dynamic nativeObjectInitializerParams);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< AnimationTargetImpl_obj > __new(Dynamic nativeObjectInitializer,Dynamic nativeObjectInitializerParams);
		...
		inline operator ::org::gameplay3d::AnimationTarget_obj *()
			{ return new ::org::gameplay3d::AnimationTarget_delegate_< AnimationTargetImpl_obj >(this); }
		inline operator ::org::gameplay3d::intern::INativeBinding_obj *()
			{ return new ::org::gameplay3d::intern::INativeBinding_delegate_< AnimationTargetImpl_obj >(this); }
		hx::Object *__ToInterface(const hx::type_info &inType);
		::String __ToString() const { return HX_CSTRING("AnimationTargetImpl"); }
...
#endif /* INCLUDED_org_gameplay3d_intern_impl_AnimationTargetImpl */ 
